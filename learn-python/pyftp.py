...
# Version:  1.0
# Create:   2014-05-19 14:01
# Copyright 2014 LEO
"""
python 具备强大的网络编程功能，而且代码简介，用简单的代码，就能实现一个功能强大的FTP 服务器。
我亲自测试了这个 python ftp server.
整个部署介绍如下:
...
3. 搭建一个测试ftp 目录
    ...
    在 /home/summer/ftp 目录下，新建 目录 :yihaomen, 目录名也就是用户名,然后再yihaomen 目录下创建 ".xxftp" 目录，
    然后在此目录中建立一个文件 password, 并用 vi 编辑，添加内容为"5f4dcc3b5aa765d61d8327deb882cf99"
    其实这就是 "password"  的 md5 加密后的字符串.
